# Event-Management
 The Event Management Dashboard is a web-based application designed to streamline the planning and execution of events. The platform consists of three primary interfaces: one tailored for users (clients) , admin and another for vendors. 
